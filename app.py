# # old version of scraper not to be used , use the modified.py for email extraction
...
#                         business_list.save_to_csv(f"google_maps_data_{search_for}".replace(' ', '_'))                        # business_list.save_to_excel(f"google_maps_data_{search_for}".replace(' ', '_'))
#                         if page.locator(address_xpath).count() > 0:
#                             business.address = page.locator(address_xpath).all()[0].inner_text()
#                         else:
#                             # Replace the address section with this clean version:
#                             if page.locator(address_xpath).count() > 0:
#                                 business.address = page.locator(address_xpath).all()[0].inner_text()
#                             else:
#                                 business.address = ""                                # Replace the address section with this clean version:
